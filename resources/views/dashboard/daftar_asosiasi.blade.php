...
<div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 689px;">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Form isian Daftar Asosiasi</h2>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Form isian Daftar Asosiasi</h5>
                    ...
                    <div class="ibox-content">
                        <h1>Daftar Asosiasi</h1>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th>Hapus</th>
                                    <th>Nama Daftar Asosiasi</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('/daftar_asosiasi/d?id=').$da['id']}}" class="btn btn-danger">
                                            <i class="fa fa-trash"></i>
                                        </a>
                                    </td>
                                    <td>{{$asosiasi_list->where('id', $da['asos_id'])->first()['nama']}}</td>
                                    <td>{{$da['created_at']}}</td>
                                </tr>
                                @endforeach
                                <tr>
                                    <form action="{{url('/daftar_asosiasi/c')}}" method="post">
                                        @csrf
