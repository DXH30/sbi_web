                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($pelabuhan as $b)
                                <tr>
                                    <td>
                                        <a href="{{url('/pelabuhan/d?id=').$b['id']}}" class="btn btn-danger">
                                ...
                                @endforeach
                                <tr>
                                    <form action="{{url('/pelabuhan/c')}}" method="post">
                                        @csrf
