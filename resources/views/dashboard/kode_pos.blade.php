                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{url('/kode_pos/d?id=').$kp['id']}}" class="btn btn-danger">
                                            <i class="fa fa-trash"></i>
                                        </a>
                                    </td>
                                    <td>{{$kp['kode']}}</td>
                                    <td>{{$provinsi->where('id_prov', $kp['id_prov'])->first()['nama'] ?? ''}}</td>
                                    <td>{{$kabupaten->where('id_kab', $kp['id_kab'])->first()['nama'] ?? ''}}</td>
                                    <td>{{$kecamatan->where('id_kec', $kp['id_kec'])->first()['nama'] ?? ''}}</td>
                                    <td>{{$kelurahan->where('id_kel', $kp['id_kel'])->first()['nama'] ?? ''}}</td>
                                </tr>
                                @endforeach
                                <tr>
                                    <form action="{{url('/kode_pos/c')}}" method="post">
                                        @csrf
