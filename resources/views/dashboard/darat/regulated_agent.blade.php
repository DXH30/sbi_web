...
<div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 689px;">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Form isian Regulated Agent</h2>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Form isian Regulated Agent</h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($regulated_agent as $ra)
                                <tr>
                                    <td>
                                        <form action="{{url('regulated_agent/d')}}" method="post">
                                            @csrf
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form method="post" enctype="multipart/form-data" action="{{url('regulated_agent/c')}}">
                            @csrf
