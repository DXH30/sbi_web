...
<div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 689px;">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Form isian Consul Barang</h2>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Form isian Consul Barang</h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($consul_barang as $cb)
                                <tr>
                                    <td>
                                        <form action="{{url('consul_barang/d')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$cb->id}}">
                                            <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </td>
                                    <td>{{$cb->asal_kota_id}}</td>
                                    <td>{{$cb->tujuan_kota_id}}</td>
                                    <td>{{$cb->type_truck_id}}</td>
                                    <td>{{$cb->sisa_load}}</td>
                                    <td>{{$cb->tanggal}}</td>
                                    <td>{{$cb->jenis_barang}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form method="post" enctype="multipart/form-data" action="{{url('consul_barang/c')}}">
                            @csrf
...
@foreach($type_truck as $tt)
<option value="{{$tt->id}}">{{json_decode($tt->deskripsi, false)->deskripsi}}</option>
@endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Sisa Load</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="number" name="sisa_load">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Jenis Barang telah di muat</label>
                                <div class="col-sm-10">
