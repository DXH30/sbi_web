                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($agent_cargo as $ac)
                                <tr>
                                    <td>
                                        <form action="{{url('agent_cargo/d')}}" method="post">
                                            @csrf
                                    ...
                                    <td>{{$ac->bandara}}</td>
                                    <td>{{$ac->asal_kota_id}}</td>
                                    <td>{{$ac->tujuan_kota_id}}</td>
                                    <td>{{$ac->rate_scheme}}</td>
                                    <td>{{$ac->commodity}}</td>
                                    <td>{{$ac->commodity_code}}</td>
                                    <td>{{$ac->charge_kg}}</td>
                                    <td>{{$ac->other_charge}}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form method="post" enctype="multipart/form-data" action="{{url('agent_cargo/c')}}">
                            @csrf
