                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($packing as $pa)
                                <tr>
                                    <td>
                                        <form action="{{url('packing/d')}}" method="post">
                                            @csrf
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form method="post" enctype="multipart/form-data" action="{{url('packing/c')}}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="airwaybill">Min/SMU (airwaybill) Rp</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="airwaybill">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="dus_rapping">Dus + Rapping Rp</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="dus_rapping">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="kayu_dus_rapping">Kayu + Dus + Rapping Rp</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="kayu_dus_rapping">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
