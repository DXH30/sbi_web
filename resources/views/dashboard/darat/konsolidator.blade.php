                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($konsolidator as $kon)
                                <tr>
                                    <td>
                                        <form action="{{url('konsolidator/d')}}" method="post">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$kon->id}}">
                                            <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                        </form>
                                    </td>
                                    <td>{{$kon->bandara}}</td>
                                    <td>{{$kon->alamat}}</td>
                                    <td>{{$kon->contact_person}}</td>
                                    <td>{{$kon->no_hp}}</td>
                                </tr>
                                @endforeach
                            </tbody>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form method="post" enctype="multipart/form-data" action="{{url('konsolidator/c')}}">
                            @csrf
