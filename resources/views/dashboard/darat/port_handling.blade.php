...
<div id="page-wrapper" class="gray-bg dashbard-1" style="min-height: 689px;">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Form isian Port Handling</h2>
            <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h5>Form isian Port Handling</h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @foreach($port_handling as $ph)
                                <tr>
                                    <td>
                                        <form action="{{url('port_handling/d')}}" method="post">
                                            @csrf
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content">
                        <form method="post" enctype="multipart/form-data" action="{{url('port_handling/c')}}">
                            @csrf
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="bandara">Dari/Ke Bandara</label>
                                <div class="col-sm-10">
                            ...
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="minimal_kg">Minimal kg</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="minimal_kg">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="estimasi_hari">Estimasi barang diterima (hari)</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="estimasi_hari">
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group row">
